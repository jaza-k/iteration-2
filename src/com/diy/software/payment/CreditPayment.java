...
public class CreditPayment {
	...
	private CardData cardReaderInterface(String pin) throws NoPowerException, ChipFailureException, IOException, IllegalStateException, InvalidPINException, BlockedCardException
	{
		...
		if (card == null || reader == null) return null; //If this check fails, then both card and reader have some non-null value
		CardData returner;
		try
		{
	...
	public boolean payForTotal()
	{
		...
		boolean flag;
		if (data == null || bank == null || total < 0) return false; //may be better to throw exceptions than return false, idk
